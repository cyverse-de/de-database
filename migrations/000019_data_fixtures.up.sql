...
-- data_formats
INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('9E2F6F6B-8C7C-42A6-B6FF-2CCA8DFFF342', 'ASN-0',
            'Genbank ASN1', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('6C4D09B3-0108-4DD3-857A-8225E0645A0A', 'Barcode-0',
            'FASTX toolkit barcode file', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('AB391836-9A4D-4EE3-89BA-9DA9CDD28255', 'CSV-0',
            'Comma-separated values', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('EBF3B544-FC03-4FDF-8C02-49CEF60B0FD6', 'EMBL-0',
            'EMBL multiple sequence alignment', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('FA6554CF-38C0-4F6E-993C-1BB080C637FA', 'FAI-0',
            'Samtools Fasta Index (FAI)', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('18FDAE69-750C-421E-B43B-5724455DAC8B', 'FASTA-0', 'FASTA',
            '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('6FEDEA87-6E73-490A-A4E3-3A337085402C', 'FASTQ-0',
            'FASTQ (Sanger)', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('B0754D3F-417B-49B3-AE2B-75339C4C392A', 'FASTQ-Illumina-0',
            'FASTQ (Illumina 1.3+)', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('06DB90D6-422A-4DF3-8DA5-ADB75BC58B65', 'FASTQ-Int-0',
            'FASTQ-Integer sequence file', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('FADDC788-FB75-434D-9820-721292ADF3B6', 'FASTQ-Solexa-0',
            'FASTQ (Solexa)', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('6DDD55C6-21C7-4E0A-B0FF-2AC1E24E9762', 'Genbank-0',
            'Genbank', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('15F121D1-7885-46F4-B2A9-32AF7EF5DDAA', 'PDB-3.2',
            'Protein Data Bank (PDB)', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('A84DA1B1-D515-44B8-8B01-AFDD660E0B77', 'Pileup-0', 'Pileup',
            '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('F3A3E9EB-E46F-49CC-A61C-24DB6EE964C4', 'SAI-0.1.2',
            'SAM index', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('13CC9A49-E3E9-4B36-9436-782323F686E0', 'SAM-0.1.2', 'SAM',
            '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('8068B37A-0921-4F34-9272-E5FC93D8F64B', 'SBML-1.2',
            'Systems Biology Markup Language (Level 1, Version 2)', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('8BC057EA-C33D-476F-82F4-61C960BEE223', 'SBML-2.4.1',
            'Systems Biology Markup Language (Level 2, Version 4, Release 1)',
            '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('E79FD13B-B82E-431D-83B6-95B3DC16DCBE', 'SBML-3.1',
            'Systems Biology Markup Language (Level 3, Version 1 Core)',
            '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('1810A7AF-094F-4470-8677-42E217CCEF4E', 'TAB-0',
            'Tab-delimited text', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('158E6939-61E2-4297-8049-42AD77B32E51', 'Text-0',
            'Plain text', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('6F7EEEC5-CEE5-4562-8515-2795C2399328', 'VCF-3.3',
            'Variant call format (VCF)', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('70E56C3C-50EB-41A7-A98C-165A9CD55EE7', 'VCF-4.0',
            'Variant call format (VCF)', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('FA730BA6-F6FA-479E-ABF4-E56F4D37D4E7', 'WIG-0',
            'UCSC Wiggle', '999');

INSERT INTO data_formats (id, name, label, display_order)
    VALUES ('E806880B-383D-4AD6-A4AB-8CDD88810A33', 'Unspecified',
            'Unspecified Data Format', '1');


-- info_type

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('212907C0-736E-4DBE-B6E7-5DC0431C275F', 'ReconcileTaxa',
               'Reconciled Taxonomy Information', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('0E3343E3-C59A-44C4-B5EE-D4501EC3A898', 'ReferenceGenome',
               'Reference Sequence and Annotations', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('57EB7FB6-BDC0-42AA-B494-0483F9347815', 'ReferenceSequence',
               'Reference Sequence Only', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('68246DDF-8B1B-44C0-827F-88945CAD8227', 'ReferenceAnnotation',
               'Reference Annotation Only', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('97D8CCF7-7242-4038-942C-235F2291AB6C', 'ACEField',
               'Reconciled Tree and Trait Information for CACE and DACE', NULL,
               TRUE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('CA9ADDE4-AB94-4A40-8C2F-C0B814156298', 'ContrastField',
               'Reconciled Tree and Trait Informaiton for Independent Contrast',
               NULL, TRUE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('E819FF9A-7398-4DF9-8191-0F5AFBBE5CA3', 'ReferenceDummyGenes',
               'Fake Reference Genome for the Cufflinks Post-Processing Step',
               NULL, TRUE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('0900E992-3BBD-4F4B-8D2D-ED289CA4E4F1', 'File', 'Unspecified',
               NULL, FALSE, '1');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('762E5A0A-AFB2-420E-8456-F79C78A29051', 'SequenceAlignment',
               'Sequence Alignment', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('F65A8F23-3E46-4DF4-80F9-387641C013A6',
               'MultipleSequenceAlignment', 'Multiple Sequence Alignment', NULL,
               FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('4A56F043-C62F-4FE9-A11F-A9A7D18E370F', 'BarcodeFile',
               'Barcode File', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('DD178256-CE77-41B0-A785-7E955799A20D', 'ExpressionData',
               'Expression Data', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('13313A72-EA0A-49DF-9105-AF798165A482', 'GenomicAnnotation',
               'Genomic Annotation', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('D4089473-139E-4345-9CA9-ADDCFC4B887E', 'BiologicalModel',
               'Biological Model', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('1C59C759-9CD3-4036-B7B4-82E8DA40D0C2',
               'NucleotideOrPeptideSequence', 'Nucleotide or Peptide Sequence',
               NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('3B4FC426-290A-4F63-ADB4-75A60A43B420', 'Structure',
               'Structure', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('A378CA30-28C9-4179-8381-EC098A89D12B', 'TraitFile',
               'Trait File', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('7BDA7EF9-7B25-43DA-93D3-A6C483FD24E4', 'TreeFile',
               'Tree File', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('F1A9CE39-B83D-4820-909E-583F76BC5EBE', 'VariantData',
               'Variant Data', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('F51BAAE3-4368-4814-BCA0-78BAD9906445', 'Archive', 'Archive',
               NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('57BD5BA7-C899-4D50-8676-A3CD56E68F8A', 'Binary', 'Binary',
               NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('3B07F544-86A6-459E-B46A-BA53E6A37F33', 'TabularData',
               'Tabular Data', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('D433BEE7-BFDE-4696-A2B8-EB2B92AC0E13', 'GraphFile',
               'Graph File', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('6270AB49-D6B6-4D8C-B15A-89657B4227A4', 'PlainText',
               'Plain Text', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('15696BC7-F712-43F3-9910-150B53272841', 'StructuredText',
               'Structured Text', NULL, FALSE, '999');

INSERT INTO info_type (id, name, label, description, deprecated, display_order)
       VALUES ('D106C3F9-93B5-4146-AAF0-727A0E8D8A50', 'Image', 'Image', NULL,
               FALSE, '999');

-- value_type

INSERT INTO value_type (id, name, description)
    VALUES ('0115898A-F81A-4598-B1A8-06E538F1D774', 'String',
            'Arbitrary text');

INSERT INTO value_type (id, name, description)
    VALUES ('E8E05E6C-5002-48C0-9167-C9733F0A9716', 'Boolean',
            'True or false value');

INSERT INTO value_type (id, name, description)
    VALUES ('BCB81292-F01D-45B1-8598-3D6CD745D2E9', 'Number',
            'Numeric value');

INSERT INTO value_type (id, name, description)
    VALUES ('94FE4F2B-42F9-4EE7-BC28-F64CC8DAF691', 'Input',
            'Input file or folder');

INSERT INTO value_type (id, name, description)
    VALUES ('65E1E927-A1ED-4E25-BC0C-74C155215973', 'Output',
            'Output file or folder');

INSERT INTO value_type (id, name, description)
    VALUES ('96DE7B1E-FE29-468F-85C0-A9458CE66FB1', 'EnvironmentVariable',
            'An environment variable that is set before running a job');

-- rule_subtype

INSERT INTO rule_subtype (id, name, description)
    VALUES ('B85DE8E1-7DDD-4F65-AD94-E896B74DC133', 'Integer', 'A whole number');

INSERT INTO rule_subtype (id, name, description)
    VALUES ('CE7C5AD2-5FCA-4611-843F-791EEE1F6E87', 'Double', 'A real number');

INSERT INTO rule_subtype (id, name, description)
    VALUES ('6BF5E9DB-86CB-4E6A-A579-0F3819E4FD68', 'String', 'Arbitrary text');
...
INSERT INTO genome_reference (id, name, path, created_by, last_modified_by)
...
INSERT INTO webhooks_topic(topic) VALUES ('data');
INSERT INTO webhooks_topic(topic) VALUES ('apps');
INSERT INTO webhooks_topic(topic) VALUES ('analysis');
INSERT INTO webhooks_topic(topic) VALUES ('permanent_id_request');
INSERT INTO webhooks_topic(topic) VALUES ('team');
INSERT INTO webhooks_topic(topic) VALUES ('tool_request');

...
(defn- add-metadata-template-attr-enum-type
  "CORE-6599: Add Metadata Template Attributes Enum type and Enum Values table.
   ...
   The files referenced in this function no longer exist because the corresponding tables
   have been moved to a different database. I'm just commenting out all of the lines in

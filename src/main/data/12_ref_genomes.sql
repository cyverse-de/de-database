...
INSERT INTO genome_reference (uuid, name, path, created_by)
VALUES ('54DC1C16-223C-458A-B186-5E570230A130','Brachypodium distachyon Brachy1.0 (Ensembl 13)',
    '/data2/collections/genomeservices/0.2/Brachypodium_distachyon.Brachy1.0/de_support/',0);

INSERT INTO genome_reference (uuid, name, path, created_by)
VALUES ('54DC1C16-225C-457A-B186-5E570229A130','Brassica rapa IVFCAASv1 (Ensembl 13)',
    '/data2/collections/genomeservices/0.2/Brassica_rapa.IVFCAASv1/de_support/',0);

INSERT INTO genome_reference (uuid, name, path, created_by)
VALUES ('70DC0C16-225C-458A-B186-5E570229A130','Caenorhabditis elegans WS220 (Ensembl 66)',
    '/data2/collections/genomeservices/0.2/Caenorhabditis_elegans.WS220/de_support/',0);

INSERT INTO genome_reference (uuid, name, path, created_by)
VALUES ('56DC0C16-222C-458A-B186-5E570228A130','Canis familiaris BROADD2 (Ensembl 66)',
    '/data2/collections/genomeservices/0.2/Canis_familiaris.BROADD2/de_support/',0);

INSERT INTO genome_reference (uuid, name, path, created_by)
VALUES ('56DC0C17-226C-458A-B186-5E570230A130','Chlamydomonas reinhardtii ENA1 (Ensembl 13)',
    '/data2/collections/genomeservices/0.2/Chlamydomonas_reinhardtii.ENA1/de_support/',0);

INSERT INTO genome_reference (uuid, name, path, created_by)
VALUES ('58DC9C16-214C-450A-B187-5E570229A130','Cyanidioschyzon merolae ENA1 (Ensembl 13)',
    '/data2/collections/genomeservices/0.2/Cyanidioschyzon_merolae.ENA1/de_support/',0);

INSERT INTO genome_reference (uuid, name, path, created_by)
VALUES ('80DC1C16-225C-454A-B188-5E570229A130','Danio rerio Zv9 (Ensembl 66)',
    '/data2/collections/genomeservices/0.2/Danio_rerio.Zv9/de_support/',0);

INSERT INTO genome_reference (uuid, name, path, created_by)
VALUES ('80DC1C16-224C-458A-B189-5E570229A130','Drosophila melanogaster BDGP5 (Ensembl 66)',
    '/data2/collections/genomeservices/0.2/Drosophila_melanogaster.BDGP5/de_support/',0);

INSERT INTO genome_reference (uuid, name, path, created_by)
VALUES ('80DC1C16-325C-459A-B186-5E570229A134','Felis catus CAT (Ensembl 66)',
    '/data2/collections/genomeservices/0.2/Felis_catus.CAT/de_support/',0);

INSERT INTO genome_reference (uuid, name, path, created_by)
VALUES ('80DC1C16-179C-458A-B186-5E570229A131','Glycine max 1.0 (Ensembl 13)',
    '/data2/collections/genomeservices/0.2/Glycine_max.1.0/de_support/',0);

INSERT INTO genome_reference (uuid, name, path, created_by)
VALUES ('80DC1C16-221C-459A-B186-5E570229A130','Homo sapiens GRCh37 (Ensembl 66)',
    '/data2/collections/genomeservices/0.2/Homo_sapiens.GRCh37/de_support/',0);

INSERT INTO genome_reference (uuid, name, path, created_by)
VALUES ('80DC1C16-225C-459A-B186-5E570229A130','Mus musculus NCBIM37 (Ensembl 66)',

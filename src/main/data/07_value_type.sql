INSERT INTO value_type (hid, id, name, description)
    VALUES ('1', '0115898A-F81A-4598-B1A8-06E538F1D774', 'String',
            'Arbitrary text');

INSERT INTO value_type (hid, id, name, description)
    VALUES ('2', 'E8E05E6C-5002-48C0-9167-C9733F0A9716', 'Boolean',
            'True or false value');

INSERT INTO value_type (hid, id, name, description)
    VALUES ('3', 'BCB81292-F01D-45B1-8598-3D6CD745D2E9', 'Number',
            'Numeric value');

INSERT INTO value_type (hid, id, name, description)
    VALUES ('4', '94FE4F2B-42F9-4EE7-BC28-F64CC8DAF691', 'Input',
